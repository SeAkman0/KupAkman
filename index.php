...
<head>
    ...
    <link rel="icon" href="logo.png" type="image/icon type" href="index.php">
    <style>
        body {
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active secilenNav" aria-current="page" href="index.php">Ana Sayfa</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="dizifilmtemali.php">Dizi-Film Karakterleri</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="carouselExample" class="carousel slide sliders">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/eharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/dharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/sally.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
                    <img src="img/akbaba.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item">
        ...
        <div class="footer-content">
            ...
            <div class="categories">
                ...
                <ul>
                    ...
                    <li><a href="kendiTasarim.html">Kendi Tasarımını Yap</a></li>
                </ul>
            </div>
            <div class="categories">
                <h3>Sosyal Medya</h3>
