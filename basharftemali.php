            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active secilenNav" aria-current="page" href="basharftemali.php">Baş Harf Temalı</a>
                        </li>
                        <li class="nav-item">
        ...
        <div id="carouselExample" class="carousel slide sliders">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="img/aharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item active">
                    <img src="img/bharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item active">
                    <img src="img/fharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item active">
                    <img src="img/gharf.png" class="d-block w-100" alt="...">
                </div>
                <div class="carousel-item active">
                    <img src="img/hharf.png" class="d-block w-100" alt="...">
                </div>
